...
import { BookOpen, ExternalLink, Download, ChevronLeft, ChevronRight, Sparkles } from "lucide-react";
import Link from "next/link";

export default function FantasyList() {
    ...
    useEffect(() => {
        const fetchFantasy = async () => {
            try {
                ...
                const response = await fetch(`${apiUrl}/api/fantasy-destaques`);
                ...
                console.error("Failed to load fantasy books", err);
            } finally {
                setLoading(false);
            }
        };
        ...
        return (
            <div className="w-full mb-12">
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">O Melhor da Fantasia 🐉</h2>
                </div>
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h2 className="text-xl md:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-red-400">
                            O Melhor da Fantasia 🐉
                        </h2>
                    </div>
                    <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">
                        Obras místicas consagradas pelos leitores
                    </p>
                </div>
